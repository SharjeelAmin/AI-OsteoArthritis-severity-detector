...
Original file is located at
    https://colab.research.google.com/drive/17sx0aFzxxHfR1-0_J54Tsd-tMUdMQBZr
...
"""# Instantiate Model & Best Param Search
...
# declare parameters
params = {
            'objective': ['reg:squarederror', 'reg:linear', 'reg:gamma'],  # List of valid objectives
...
random_search = RandomizedSearchCV(estimator=xgb_r, param_distributions=params, n_iter=1500, cv=5, n_jobs=-1, verbose=2, random_state=42)
random_search.fit(X_train, y_train)

random_search.best_params_

xgb_r = xg.XGBRegressor(colsample_bytree= random_search.best_params_['colsample_bytree'],
